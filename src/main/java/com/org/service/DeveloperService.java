...
public class DeveloperService {
    ...
    public DeveloperResponse create(DeveloperRequest request){
        ...
        Developer saved=developerRepository.save(developerMapper.toEntitu(request));
    ...
    @Transactional(readOnly = true)
    public Page<DeveloperResponse> findPaginated(Pageable pageable) {
    ...
    public void delete(Long id){
        Developer dev = developerRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Developer no encontrado"));
